...
<body>
     ...
     <br>
     <a href="${pageContext.request.contextPath}/users/view/1/use/Map" target="_blank">Controller中如何将model数据返回给页面，方式三：通过java.util.Map实现</a>
     <br>
     <a href="${pageContext.request.contextPath}/users/view/1/use/SessionAttributes" target="_blank">Controller中如何将model数据返回给页面，方式三：通过jorg.springframework.web.bind.annotation.SessionAttributes标注指定Model中的某些数据也存储到HttpSession中</a>
     <br>
     <a href="${pageContext.request.contextPath}/users/view/1/use/ModelAttribute" target="_blank">Controller中如何将model数据返回给页面，方式三：通过jorg.springframework.web.bind.annotation.SessionAttributes实现</a>
