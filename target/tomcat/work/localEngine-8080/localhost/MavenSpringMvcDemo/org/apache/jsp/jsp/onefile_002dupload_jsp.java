...
public final class onefile_002dupload_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>当个文件上传demo，本案例限制了只能上传图片</title>\r\n");
      ...
      out.write("       \t           }\r\n");
      out.write("       \t     }\r\n");
      out.write("    \t }else{ //兼容有的IE浏览器不支持的情况\r\n");
      out.write("    \t\t var filePath = el.value;\r\n");
      out.write("    \t     var fileSystem = new ActiveXObject(\"Scripting.FileSystemObject\");        \r\n");
      out.write("    \t     var file = fileSystem.GetFile (filePath);\r\n");
      out.write("\t         var fileName = file.name;    //文件名\r\n");
      out.write("  \t         var fileType = file.type;    //文件类型\r\n");
      out.write("  \t         var fileSize = file.size;    //文件大小，单位为byte（字节）\r\n");
      out.write("  \t      \r\n");
      out.write("  \t         var typeAccepted = false;\r\n");
      out.write("  \t         for(var j = 0; j < allowTypes.length; j++){\r\n");
      out.write("  \t    \t     if(allowTypes[j] == fileType){\r\n");
      ...
      out.write("/onefile/upload\" method=\"post\" enctype=\"multipart/form-data\" onsubmit=\"return checkForm();\">\r\n");
      out.write("        <input type=\"file\" name=\"file1\" id=\"file1\" onchange=\"checkFile(this)\"/> <br>\r\n");
